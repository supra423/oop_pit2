...
public record Material(int materialId, String name, String unitOfMeasure, double price, int stockQuantity) {
    // this overloaded constructor can be used for instantiating new material objects that are yet to be added
    // to the database
    public Material(String name, String unitOfMeasure, double price, int stockQuantity) {
